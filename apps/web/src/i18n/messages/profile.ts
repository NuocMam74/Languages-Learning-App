...
export const fr = {
  ...
  // Bulletin : note par niveau, moyenne, thèmes à reprendre (contrat phase21 §4)
  "profile.marks.title": "Notes par thème",
  "profile.marks.overall": "Moyenne générale",
  "profile.marks.overall.on": "sur {n} niveau terminé",
  "profile.marks.overall.on.plural": "sur {n} niveaux terminés",
  "profile.marks.empty": "Termine un niveau et ta première note s'affiche ici.",
  "profile.marks.value": "{mark}/{max}",
  "profile.marks.progress": "{n} niveau sur {total}",
  "profile.marks.progress.plural": "{n} niveaux sur {total}",
  "profile.marks.untouched": "Pas encore abordé",
  "profile.marks.level.fragile": "À reprendre",
  "profile.marks.level.solid": "Ça tient",
  "profile.marks.level.strong": "Acquis",
  "profile.marks.weak.title": "À retravailler en premier",
  "profile.marks.weak.redo": "Refaire « {title} »",
  "profile.marks.note": "La note d’un niveau, c’est ton meilleur essai, ramené sur 20. Refaire un niveau ne peut que la faire monter.",
...
export const en: Record<keyof typeof fr, string> = {
  ...
  "profile.marks.title": "Marks by theme",
  "profile.marks.overall": "Overall average",
  "profile.marks.overall.on": "across {n} completed level",
  "profile.marks.overall.on.plural": "across {n} completed levels",
  "profile.marks.empty": "Finish a level and your first mark shows up here.",
  "profile.marks.value": "{mark}/{max}",
  "profile.marks.progress": "{n} level of {total}",
  "profile.marks.progress.plural": "{n} levels of {total}",
  "profile.marks.untouched": "Not started yet",
  "profile.marks.level.fragile": "Needs work",
  "profile.marks.level.solid": "Holding up",
  "profile.marks.level.strong": "Solid",
  "profile.marks.weak.title": "Work on these first",
  "profile.marks.weak.redo": "Redo “{title}”",
  "profile.marks.note": "A level’s mark is your best attempt, scaled to 20. Redoing a level can only raise it.",
